...
//    	}
    ...
    // work here
    public static void senseBadScouts() throws Exception {
    	for (Robot r : rc.senseNearbyAirRobots()) {
			
			// work here
			double a = rc.senseEventualEnergonOf(r); 
			if (a > 15 && rc.senseRobotTypeOf(r) == SCOUT) {
				System.out.println("aaa = " + a + " r" + Clock.getRoundNum() + " id:" + id + "/" +
						r.getID() + " hh:" + rc.senseEnergonLevelOf(r));
				rc.suicide();
			}
    	...
    	try {
	        ...
	        while (true) {
	            try {
	            	...
	            	if (type == SCOUT) {
	            		if (id == 56 && Clock.getRoundNum() == 99) {
	            			System.out.println("56 energon = " + rc.getEnergonLevel());
	            			System.out.println("56 Eenergon = " + rc.getEventualEnergonLevel());
	            		}
	            		if (id == 56 && Clock.getRoundNum() == 100) {
	            			System.out.println("56 energon = " + rc.getEnergonLevel());
	            			System.out.println("56 Eenergon = " + rc.getEventualEnergonLevel());
	            		}
	            		// work here
