...
//    	}
    ...
    public void run() {
    	try {
	    	...
	    	while (true) {
	    		if (Clock.getRoundNum() >= baseRound) {
	    			break;
	    		}
	    		rc.yield();
	    	}
	    	...
	    	for (int i = 0; i < locs.length; i++) {
	    		if (rc.getLocation().equals(locs[i])) {
	    			I = i;
	    		}
	    	}
	    	
	    	System.out.println("================== 1.0 " + rc.getLocation().isAdjacentTo(rc.getLocation()));
	    	System.out.println("round = " + round());
	    	System.out.println("I = " + I);
	    	System.out.println("energon = " + rc.getEnergonLevel());
	    	System.out.println("eventual = " + rc.senseEventualEnergonOf(r));
	    	System.out.println("eventual3 = " + rc.senseEventualEnergonOf(rc.senseGroundRobotAtLocation(locs[3])));
	    	
	    	
	    	if (I == 1) {
	    		rc.transferEnergon(10, locs[3], MapHeight.ON_GROUND);
	    		rc.yield();
	    	} else {
	    	}
	    	...
	    	while (true) {
	    		if (Clock.getRoundNum() >= baseRound + 1) {
	    			break;
	    		}
	    		rc.yield();
	    	}
	    	...
	    	while (true) {
	    		if (Clock.getRoundNum() >= baseRound + 2) {
	    			break;
	    		}
	    		rc.yield();
	    	}
