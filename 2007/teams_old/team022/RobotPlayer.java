...
//			            		if (leader && !tryingToRunAway) {
			            		...
			            		if (leader || (leaderIndex % 2 == 0)) {
			            			...
			            			boolean closeFriendlyTank = (rc.getUnitCount(TANK) == 0);
				            		...
				            		for (Robot r : rc.senseNearbyGroundRobots()) {
				            			if (r.getTeam() != team) {
				            				...
				            				RobotType t = rc.senseRobotTypeOf(r);
				            				if (t == TANK && rc.senseLocationOf(r).distanceSquaredTo(loc) <= 4) {
				            					closeFriendlyTank = true;
				            				}
				            			}
				            		}
				            		for (Robot r : rc.senseNearbyAirRobots()) {
				            		...
				            		if (attackMode || (leader && !closeFriendlyTank && !tryingToRunAway)) {
				            			rc.yield();
				            			continue;
				            		}
			            		}			      
