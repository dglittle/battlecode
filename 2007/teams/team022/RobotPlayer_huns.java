...
public class RobotPlayer_huns implements Runnable {
    ...
    public RobotPlayer_huns(RobotController rc) {
    	RobotPlayer_huns.rc = rc;
        r = rc.getRobot();
        id = r.getID();
        team = r.getTeam();
    ...
    public static void updateMapTop(int mapTop) {
    	if (RobotPlayer_huns.mapTop < mapTop) {
        	RobotPlayer_huns.mapTop = mapTop;
    ...
    public static void updateMapBottom(int mapBottom) {
    	if (RobotPlayer_huns.mapBottom > mapBottom) {
    		RobotPlayer_huns.mapBottom = mapBottom;
    ...
    public static void updateMapLeft(int mapLeft) {
    	if (RobotPlayer_huns.mapLeft < mapLeft) {
    		RobotPlayer_huns.mapLeft = mapLeft;
    ...
    public static void updateMapRight(int mapRight) {
    	if (RobotPlayer_huns.mapRight > mapRight) {
    		RobotPlayer_huns.mapRight = mapRight;
...
//    	}
    ...
    public static void sendInfo(boolean everything) throws Exception {
    	Set<MapLocation> wallSet = everything ? RobotPlayer_huns.wallSet : newWallSet;
    	Set<MapLocation> upgradeSet = everything ? RobotPlayer_huns.upgradeSet : newUpgradeSet;
    	Set<MapLocation> nogradeSet = everything ? RobotPlayer_huns.nogradeSet : newNogradeSet;
