...
public final class X {
   ...
   */
  public static void setDirection(Direction direction) throws GameActionException {
  ...
  public static final void attack(MapLocation target, RobotLevel level) {
    ...
    for (int i = 0; i < weaponCount; i++) {
      ...
      try {
        ...
        e.printStackTrace();  // This really shouldn't happen under any circumstance.
      }
    }
  }
  ...
  public static void moveDir(Direction d) throws GameActionException {
    if (S.direction == d) {
      
      // work here
      S.rc.setIndicatorString(0, "AA: " + S.direction);
      
      X.moveForward();
    } else if (S.direction.opposite() == d) {
      
      // work here
      S.rc.setIndicatorString(0, "BB");
      
      X.moveBackward();
    } else {
      
      // work here
      S.rc.setIndicatorString(0, "CC");
  ...
  public static void build(Chassis chassis, MapLocation loc) throws GameActionException {
  ...
  * @throws GameActionException
  */
  public static final MapLocation tryBuild(Chassis chassis) throws GameActionException {
  ...
  /**
  * Requires have enough flux and the controller is not active.
  * Try to build a component on chassis in the square immediately adjacent to myself.
  ...
  * @throws GameActionException
  */
  public static final boolean tryBuild(ComponentType ct, MapLocation there, RobotLevel level) 
      throws GameActionException {
