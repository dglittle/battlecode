...
public class MineHuntingBlock {
  ...
  public static final boolean async() {
    ...
    if (_goalLocation.equals(S.location)) {
      ...
      if (!BuildBlock.busy) {
        BuildBlock.setBuildOrder(_mineChassis, _mineComponents,
            new MapLocation[] {_goalLocation}, _mineTag);
        return true;
      }
    }
    return false;
   ...
   */
  public static final boolean scoutForMines() {
    _checkGoalMine();
  ...
  /**
   * Makes sure that the goal mine is still available for colonization.
   */
  ...
  public static Chassis[] _mineChassis = {Role.RECYCLER.chassis};
  public static ComponentType[][] _mineComponents = {Role.RECYCLER.components};
  /** Tag for the mine build order. */
  public static final Object _mineTag = "MineHunting";  
