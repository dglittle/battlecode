...
import heavy1.chaos.LandaUtil;
import heavy1.chaos.Strategy;
import heavy1.chaos.SurveyNavigationBlock;
...
//        stateTransition(StrategyState.BUILDER_ELECTION); // FIXME(landa): Why is this being called right away if there's a sync function above this line?
      }
      else {
