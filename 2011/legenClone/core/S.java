...
public final class S {
  ...
  public static final Mine senseMine(MapLocation m)
  ...
  public static boolean allowedToBuild(Chassis chassis,
    ...
    return allowedToBuild(cost, upkeep);
  }

  public static boolean allowedToBuild(double cost, double upkeep) {
