package sprint3.blocks.pathfinding;
...
public final class BFHPathfinding {
  ...
  public static final Direction nextDirection(Direction bestDirection) {
    ...
    for (int i = XDirection.ADJACENT_DIRECTIONS - 1; i >= 0; i--) {
      int cost = _minCost[_sourceMX + XDirection.intToDeltaX[directionInt]][_sourceMY + XDirection.intToDeltaY[directionInt]] + XDirection.pathfindingCost[directionInt];
