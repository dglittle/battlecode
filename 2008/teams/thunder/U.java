...
public class U {
	...
	public static boolean inRange(MapLocation a, MapLocation b, RobotType type) {
		int distSq = a.distanceSquaredTo(b);
		return distSq >= type.attackRadiusMinSquared() && distSq <= type.attackRadiusMaxSquared();
	}
