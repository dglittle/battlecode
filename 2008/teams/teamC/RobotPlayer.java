...
public class RobotPlayer implements Runnable {
	...
	public static double[] desired_unit_percent = new double[] {0.15476260250976637, 0.0, 0.0314679345481461, 0.06972717808008276, 0.20994205172245106, 0.5341002331395537};
	...
	public static double energon_to_consider_spawning_bomber = 7.982904669930208; // [0.0, 10.0]
	public static double energon_to_consider_spawning_mortar = 10.92314553877694; // [0.0, 20.0]
	public static double energon_to_consider_spawning_sniper = 7.294219618883879; // [0.0, 20.0]
	...
	public static double willingness_to_move_backwards = 0.6118005054706452; // [0.0, 1.0]
	...
	public static double grouping_desire = 4.23061726249851; // [0.0, 10.0]
	public static double desire_to_get_in_range_of_enemy_target = 0.5827490164774728; // [0.0, 1.0]
	public static double desire_to_approach_enemy_target = 0.6989467896321465; // [0.0, 1.0]
	public static double desire_to_face_enemy_target = 0.8277428360215127; // [0.0, 1.0]
	public static double generosity = 4.105508543266575; // [0.0, 10.0]
	...
	public static double max_message_age_float = 4.185111501730906; // [0.0, 10.0]
	public static double max_shared_concept_age_float = 6.922450853586696; // [0.0, 10.0]
	public static double auto_formatting_helper = 0.5832436040082213; // [0.0, 1.0]
