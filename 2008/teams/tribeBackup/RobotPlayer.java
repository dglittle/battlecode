...
public class RobotPlayer implements Runnable {
	...
	public static final int _bestTowerEnemy = 3;
	public static final int _numSharedConcepts = 4;
	...
	public static void makeMovementDecision() throws Exception {
		...
		SharedConcept bestTowerEnemy = sharedConcepts[_bestTowerEnemy];
			...
			for (Robot r : rc.senseNearbyGroundRobots()) {
				...
				if (team.equals(i.team)) {
					...
					if (i.type == RobotType.TOWER) {
						...
						bestTowerEnemy.improve(dist, pos, currentRound);
					}
