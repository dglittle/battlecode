...
public class RobotPlayer implements Runnable {
	...
	public static double[] desired_unit_percent = new double[] {0.1652081760579993, 0.0, 0.033591836701529036, 0.0744333561562771, 0.2058930582877568, 0.5208735727964378};
	public static double energon_to_consider_spawning_scout = 30.392364584480436; // [0.0, 50.0]
	public static double energon_to_consider_spawning_soldier = 49.22509552744669; // [0.0, 50.0]
	public static double energon_to_consider_spawning_bomber = 8.347919831495712; // [0.0, 10.0]
	public static double energon_to_consider_spawning_mortar = 3.016973515838157; // [0.0, 20.0]
	public static double energon_to_consider_spawning_sniper = 8.189957955953437; // [0.0, 20.0]
	public static double desire_to_turn_given_spawn_desire = 0.1902699032136922; // [0.0, 1.0]
	public static double desire_to_move_toward_enemy_archon = 0.7293104887879124; // [0.0, 1.0]
	public static double multiplier_given_that_enemy_archon_is_seen = 1.444624848235221; // [0.0, 3.0]
	public static double desire_to_move_toward_enemy_tower = 0.6689088833732313; // [0.0, 1.0]
	public static double multiplier_given_that_enemy_tower_is_seen = 1.5979324471525627; // [0.0, 3.0]
	public static double desire_to_move_given_spawn_desire = 0.9950628108791881; // [0.0, 1.0]
	public static double willingness_to_move_backwards = 0.9508985536735599; // [0.0, 1.0]
	public static double grouping_radius = 5.323157044325997; // [0.0, 10.0]
	public static double grouping_func_exponent = 7.452316320237306; // [0.0, 10.0]
	public static double grouping_desire = 7.106267116950487; // [0.0, 10.0]
	public static double desire_to_get_in_range_of_enemy_target = 0.5827490164774728; // [0.0, 1.0]
	public static double desire_to_approach_enemy_target = 0.5207988289944735; // [0.0, 1.0]
	public static double desire_to_face_enemy_target = 0.8277428360215127; // [0.0, 1.0]
	public static double generosity = 3.866756097253493; // [0.0, 10.0]
	public static double willingness_to_give_to_tower = 0.6825944030409896; // [0.0, 1.0]
	public static double tower_dist_penalty_for_non_mortars = -0.3599660253604391; // [-10.0, 10.0]
	public static double tower_dist_penalty_for_mortars = -7.670200557975424; // [-10.0, 10.0]
	public static double consider_at_most_this_many_messages_float = 7.203875123616602; // [0.0, 10.0]
	public static double max_message_age_float = 2.3807087488617333; // [0.0, 10.0]
	public static double max_shared_concept_age_float = 6.928810488780683; // [0.0, 10.0]
	public static double auto_formatting_helper = 0.5274612709262082; // [0.0, 1.0]
